 ...
 * Time: 18:20
 */
include("F:/TMJoker/xampp/jpgraph/jpgraph/jpgraph.php");
include_once ("F:/TMJoker/xampp/jpgraph/jpgraph/jpgraph_pie.php");
include_once ("F:/TMJoker/xampp/jpgraph/jpgraph/jpgraph_pie3d.php");			//引用3D饼图PiePlot3D对象所在的类文件
$data = array(266036,295621,335851,254256,254254,685425);			//定义数组
$graph = new PieGraph(640,360,'auto');				//创建画布
